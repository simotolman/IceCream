  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> IceCream@gmail.com</li>
          <li>Free Shipping for all Order of $9</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: Guliz Marrakech</li>
                <li>Phone: +212 0602832757</li>
                <li>Email: IceCream@gmail.com</li>
              </ul>
            </div>
          </div>
